...
func (v *Validator) Validate(dataplane *apisixoperatorv1alpha1.DataPlane) error {
...
func (v *Validator) ValidateDeployOptions(namespace string, opts *apisixoperatorv1alpha1.DeploymentOptions) error {
