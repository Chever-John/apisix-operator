...
//+kubebuilder:rbac:groups=apisix-operator.apisix-operator.apisix.apache.org,resources=controlplanes/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=apisix-operator.apisix-operator.apisix.apache.org,resources=controlplanes/finalizers,verbs=update
